...
type Student struct {
	...
	RollNumber      string `boil:"roll_number" json:"roll_number" toml:"roll_number" yaml:"roll_number"`
	StudentName     string `boil:"student_name" json:"student_name" toml:"student_name" yaml:"student_name"`
...
var StudentWhere = struct {
	ID              whereHelperint
	RollNumber      whereHelperstring
	StudentName     whereHelperstring
	Email           whereHelperstring
	AdmissionNumber whereHelperstring
}{
	ID:              whereHelperint{field: "\"students\".\"id\""},
	RollNumber:      whereHelperstring{field: "\"students\".\"roll_number\""},
	StudentName:     whereHelperstring{field: "\"students\".\"student_name\""},
...
var (
	studentAllColumns            = []string{"id", "roll_number", "student_name", "email", "admission_number"}
	studentColumnsWithoutDefault = []string{"roll_number", "student_name", "email", "admission_number"}
...
var studentAfterSelectMu sync.Mutex
var studentAfterSelectHooks []StudentHook

var studentBeforeInsertMu sync.Mutex
var studentBeforeInsertHooks []StudentHook
var studentAfterInsertMu sync.Mutex
var studentAfterInsertHooks []StudentHook

var studentBeforeUpdateMu sync.Mutex
var studentBeforeUpdateHooks []StudentHook
var studentAfterUpdateMu sync.Mutex
var studentAfterUpdateHooks []StudentHook

var studentBeforeDeleteMu sync.Mutex
var studentBeforeDeleteHooks []StudentHook
var studentAfterDeleteMu sync.Mutex
var studentAfterDeleteHooks []StudentHook

var studentBeforeUpsertMu sync.Mutex
var studentBeforeUpsertHooks []StudentHook
var studentAfterUpsertMu sync.Mutex
...
func (o *Student) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(studentAllColumns, strmangle.SetIntersect(insert, update))

		conflict := conflictColumns
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(studentPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert students, could not build conflict column list")
			}

			conflict = make([]string, len(studentPrimaryKeyColumns))
			copy(conflict, studentPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"students\"", updateOnConflict, ret, update, conflict, insert, opts...)
